...
let france = new Country('France', 'Europe', 'Euro', '67.75 million');
let zambia = new Country('Zambia', 'Africa', 'Zambian Kwacha', '19.47 million');
let vietnam = new Country('Vietnam', 'Asia', 'Vietnemese Dong', '97.47 million');

france.getOverview();
france.setPopulation('70.12 million');
france.getOverview();
//##DISPLAY_END##
...
const hints = [
    "Remember JavaScript classes use contructor functions.",
    "You can use template strings to combine JavaScript expressions with strings.",
    "The `setPopulation` function can be defined inside the class."
];
